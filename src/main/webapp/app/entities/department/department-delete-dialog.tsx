...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jHipsterTrialApp.department.delete.question">
        <Translate contentKey="jHipsterTrialApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
