...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jHipsterTrialApp.jobHistory.delete.question">
        <Translate contentKey="jHipsterTrialApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
